        ...
        <Grid className={classes.headContainer} container>
          <Grid item xs={2}>
            <Card className={classes.titleCard} container>
              <PublicRoundedIcon sx={{height: "100%", width: "100%", color:"#7E7A7A"}}/>
            </Card>
          </Grid>
          <Grid item xs={10} className={classes.detailsContainer} container>
            <Typography variant="h4" className={classes.heading}>{planet.name}</Typography>
            <Typography variant="body" className={classes.detail}>{planet.diameter}</Typography>
            <Grid className={classes.keyValueContainer} container>
              <Typography variant="body" className={classes.key}>terrain  :-</Typography>
              <Typography variant="body" className={classes.value}>{planet.terrain}</Typography>
            </Grid>
            <Grid className={classes.keyValueContainer} container>
              <Typography variant="body" className={classes.key}>Population :-</Typography>
              <Typography variant="body" className={classes.value}>{planet.population}</Typography>
            </Grid>
